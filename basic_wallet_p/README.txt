...
This app should:
    * Allow the user to enter, save, or change the `id` used for the program [x]
    * Display the current balance for that user [x]
    * Display a list of all transactions for this user, including sender and recipient [x]

Stretch Goals:
    * Use styling to visually distinguish coins sent and coins received [x]
